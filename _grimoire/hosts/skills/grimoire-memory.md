...
> Mémoire projet Grimoire : retrouver une décision passée, un incident ou une convention, et consigner ce qui doit survivre à la session. À utiliser avant de reprendre un sujet déjà traité, et après toute décision non déductible du code.
